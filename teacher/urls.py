...
from .views import HireListCreateView, HireDetailView, JobAlertListCreateView, JobAlertDetailView, RecommendedJobsView, HireCvView
...
urlpatterns = [
    ...
    path('job/hire/<int:hire_id>/cv', HireCvView.as_view(), name='hire-cv'),
